...
pub struct Options {
    ...
    #[deprecated(
        since = "0.1.1",
        note = "Renamed to `line-width` to emphasize that the limit is the line's display width rather than the number of characters . Use `line-width = <value>` instead."
    )]
...
pub struct PycodestyleOptions {
    ...
    #[deprecated(
        since = "0.1.1",
        note = "Renamed to `max-doc-width` to emphasize that the limit is the line's display width rather than the number of characters . Use `max-doc-width = <value>` instead."
    )]
