...
This document enumerates the known, intentional differences in code style between Black and the
Ruff Formatter.
...
### <code>global</code> and <code>nonlocal</code> names are broken across multiple lines by continuations
